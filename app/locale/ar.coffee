...
#  new_home:
    title: "CodeCombat - تكويد الالعاب - لتعلم برمجة Python و JavaScript"
...
#    century_skills_subblurb4: "Coding requires kids to practice new forms of communication, including communicating with the computer itself and conveying their ideas using the most efficient code."
    classroom_in_box_title: "نحن نسعي جاهدين إلى :"
...
#    creativity_rigor_blurb3: "CodeCombat’s self-paced, standards-aligned curriculum makes teaching computer science possible for everyone. CodeCombat equips teachers with the training, instructional resources, and dedicated support to feel confident and successful in the classroom."
    featured_partners_title1: "يعلن عنه في"
    featured_partners_title2: "الجوائز & الشركاء"
...
#    global_title: "Join Our Global Community of Learners and Educators"
    ...
    global_subtitle2: "اسطر من الكود"
    global_subtitle3: "المعلمون"
    global_subtitle4: "البلدان"
    go_to_my_classes: "الذهاب إلى الصف"
    go_to_my_courses: "الذهاب إلى الدورات"
...
#    slogan: "The most engaging way to learn computer science"
    teach_cs1_free: "تعليم CS1 مجانا"
...
#    teachers_love_codecombat_subblurb: "In partnership with McREL International, a leader in research-based guidance and evaluations of educational technology."
    ...
    classroom_edition: "إصدارات الفصول الدراسية:"
    learn_to_code: "تعلم الكود:"
    play_now: "إلعب الآن"
    im_an_educator: "انا مربى"
    im_a_teacher: "انا مدرس"
...
#    create_individual_header: "Create Individual Account"
    ...
    sign_in_to_continue: "تسجيل الدخول أو إنشاء حساب للمتابعة"
...
#    classroom_not_found: "No classes exist with this Class Code. Check your spelling or ask your teacher for help."
    checking: "فحص..."
    account_exists: "هذا البريد مستخدم بالفعل :"
    sign_in: "تسجيل الدخول"
    email_good: "البريد الإلكتروني يبدو جيدا"
#    name_taken: "Username already taken! Try {{suggestedName}}?"
#    name_available: "اسم المستخدم متاح!"
#    name_is_email: "اسم المستخدم قد لا يكون بريدًا إلكترونيًا"
...
#  ozaria_chrome:
    sound_off: "إغلاق الصوت"
    sound_on: "تشغيل الصوت"
    back_to_map: "الرجوع للخريطة"
    level_options: "خيارات المستوى"
    restart_level: "إعادة المستوى"
